...
import { CartesianGrid, XAxis, YAxis,Tooltip,Label, ScatterChart,Scatter} from 'recharts';
...
function Groups()
{
    ...
    return (
        <Container>
            ...
            {renderScatterChart(measurement?formatData(measurement.clusters):[],"campo magnético")}
        </Container>
    );
}
